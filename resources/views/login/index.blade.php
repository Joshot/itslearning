...
<div class="flex w-full h-full flex-col max-[765px]:flex-col md:flex-row">
    ...
    <div class="w-full max-[765px]:h-4/5 md:w-1/2 md:h-auto bg-white flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 min-h-screen max-[765px]:min-h-0">
        ...
        <h1 style="color: #54606b" class="font-bold text-xl sm:text-2xl md:text-3xl mb-6">Sign In Regular S1/D3</h1>
        ...
        <form action="{{ route('login.process') }}" method="POST" class="w-full max-w-xs sm:max-w-sm md:max-w-md" onsubmit="return validateForm()">
            @csrf
            <div class="mb-4">
