            ...
            <form id="profileForm" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" value="{{ Auth::guard('student')->user()->name }}" class="disabled-input" disabled>
                    </div>
                    <div class="mb-4">
                        <label for="nim" class="block">NIM</label>
                        <input type="text" id="nim" name="nim" value="{{ Auth::guard('student')->user()->nim }}" class="disabled-input" disabled>
                    </div>
                    <div class="mb-4">
                        <label for="email" class="block">Email</label>
                        <input type="email" id="email" name="email" value="{{ Auth::guard('student')->user()->email }}" class="disabled-input" disabled>
                    </div>
                    <div class="mb-4">
                        <label for="major" class="block">Major</label>
                        <input type="text" id="major" name="major" value="{{ Auth::guard('student')->user()->major }}" class="disabled-input" disabled>
                    </div>
                    <div class="mb-4">
                        <label for="angkatan" class="block">Angkatan</label>
                        <input type="text" id="angkatan" name="angkatan" value="{{ Auth::guard('student')->user()->angkatan }}" class="disabled-input" disabled>
                    </div>
                    <div class="mb-4">
                        <label for="motto" class="block">Motto</label>
                        <input type="text" id="motto" name="motto" value="{{ Auth::guard('student')->user()->motto ?? '' }}">
                    </div>
                    <div class="mb-4">
